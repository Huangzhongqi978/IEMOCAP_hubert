...
rootdir = '/home/Shi22/nas01home/Database/IEMOCAP/IEMOCAP_full_release/'
processor = Wav2Vec2Processor.from_pretrained("facebook/wav2vec2-base-960h")
model = HubertModel.from_pretrained("facebook/hubert-base-ls960")   # 用于提取通用特征，768维
...
def Seg_IEMOCAP(train_data_text,train_data_trad):
...
if __name__ == '__main__':
    ...
    train_data_map = Seg_IEMOCAP(train_data_text,train_data_trad)
    Train_data = Train_data(train_data_map)

    file = open('/home/Shi22/nas01home/Cooperation/Yongwei/IEMOCAP/IEMOCAP_hubert/Train_data_org.pickle', 'wb')
